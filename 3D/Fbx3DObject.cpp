...
ID3D12Device* Fbx3DObject::device = nullptr;
Camera* Fbx3DObject::camera = nullptr;

ComPtr<ID3D12RootSignature> Fbx3DObject::rootsignature;
ComPtr<ID3D12PipelineState> Fbx3DObject::pipelinestate;

void Fbx3DObject::CreateGraphicsPipeline()
{
...
void Fbx3DObject::Draw(ID3D12GraphicsCommandList* commandList)
{
	if(model == nullptr)
	{
		return ;
...
void Fbx3DObject::PlayAnimation()
{
