...
#pragma region ビルボード計算
	...
	////X軸は共通
	//ybillCameraAxisX = {matView.r[0].m128_f32[0],matView.r[0].m128_f32[1],matView.r[0].m128_f32[2],0};
	////Y軸はワールド座標系のY軸
	//ybillCameraAxisY = XMVector3Normalize({0,1,0});
	////Z軸はX軸->Y軸の外積で求まる
	//ybillCameraAxisZ = XMVector3Cross(
	//	{matView.r[0].m128_f32[0],matView.r[0].m128_f32[1],matView.r[0].m128_f32[2],0},
	//	{matView.r[2].m128_f32[0],matView.r[2].m128_f32[1],matView.r[2].m128_f32[2],0});
